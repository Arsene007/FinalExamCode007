...
public class Retirement {
	...
	public Retirement(int iYearsToWork, double dAnnualReturnWorking, int iYearsRetired, double dAnnualReturnRetired,
			double dRequiredIncome, double dMonthlySSI, double monthlySSI) {
		super();
	...
	public double MonthlySavings() {
		...
		double pmt = Math.round(Math.abs(Retirement.PMT(dAnnualReturnRetired/ 12, iYearsRetired*12, this.TotalAmountToSave(),0,iYearsRetired, false))*100.0)/100.0;
		return pmt;
	}
	...
	public static double PMT(double r, double n, double p, double f, int i, boolean t) {
		//	r = Rate
